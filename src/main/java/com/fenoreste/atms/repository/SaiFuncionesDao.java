...
public interface SaiFuncionesDao extends CrudRepository<Auxiliar ,Integer>  {
	...
	@Query(value = "SELECT sai_cajero_receptor_limite_adelanto(?1,?2,?3,(SELECT date(fechatrabajo) FROM origenes limit 1),NULL)", nativeQuery = true)
