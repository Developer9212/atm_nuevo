...
public interface FuncionesDao extends CrudRepository<Auxiliar ,Integer>  {
	...
	public String sai_procesa_transaccion(Integer idusuario,String sesion,String referencia);
	...
	public String sai_limite_adelanto(Integer idorigenp,Integer idproducto,Integer idauxiliar,BigDecimal monto);
	...
	public String monto_liquidar_prestamos(Integer idorigenp,Integer idproducto,Integer idauxiliar,Date fecha);
